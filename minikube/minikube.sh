...
# deployment.apps/hello-mediatr-api-dev created

kubectl apply -f minikube/service.yaml
# service/hello-mediatr-api-dev-svc created

#================================================================
# Expose endpoint
#================================================================
minikube service hello-mediatr-api-dev-svc --url
# service default/hello-mediatr-api-dev-svc has no node port
# 🏃  Starting tunnel for service hello-mediatr-api-dev-svc.
# |-----------|------------|-------------|------------------------|
# | NAMESPACE |    NAME    | TARGET PORT |          URL           |
# |-----------|------------|-------------|------------------------|
# | default   | hello-svc  |             | http://127.0.0.1:36883 |
# |-----------|------------|-------------|------------------------|
# http://127.0.0.1:36883
# ❗  Because you are using a Docker driver on linux, the terminal needs to be open to run it.
# ^C✋  Stopping tunnel for service hello-mediatr-api-dev-svc.
# 
...
#================================================================
kubectl rollout status deployment/hello-mediatr-api-dev
# deployment "hello-mediatr-api-dev" successfully rolled out
...
# hello-mediatr-api-dev     2/2     2            2           16m

kubectl get po -n default # or pod, or pods
# NAME                                      READY   STATUS    RESTARTS   AGE
# hello-mediatr-api-dev-8587dff54d-6djtd    1/1     Running   0          3m39s
# hello-mediatr-api-dev-8587dff54d-99s9r    1/1     Running   0          2m52s

kubectl get svc -n default # or service, or services
# NAME                          TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)   AGE
# hello-mediatr-api-dev-svc     ClusterIP   10.101.34.169   <none>        80/TCP    16m
...
# NAME                                          READY   STATUS    RESTARTS   AGE
# pod/hello-mediatr-api-dev-8587dff54d-6djtd    1/1     Running   0          6m42s
# pod/hello-mediatr-api-dev-8587dff54d-99s9r    1/1     Running   0          5m55s

# NAME                                  TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)   AGE
# service/hello-mediatr-api-dev-svc     ClusterIP   10.101.34.169   <none>        80/TCP    18m
# service/kubernetes                    ClusterIP   10.96.0.1       <none>        443/TCP   80m

# NAME                                  READY   UP-TO-DATE   AVAILABLE   AGE
# deployment.apps/hello-mediatr-api-dev 2/2     2            2           19m

# NAME                                              DESIRED   CURRENT   READY   AGE
# replicaset.apps/hello-mediatr-api-dev-6cb4fcfbfb  0         0         0       19m
# replicaset.apps/hello-mediatr-api-dev-8587dff54d  2         2         2       6m42s
# kevinwu@HP:~$ k get all -n default
# NAME                                          READY   STATUS    RESTARTS   AGE
# pod/hello-mediatr-api-dev-8587dff54d-6djtd    1/1     Running   0          7m16s
# pod/hello-mediatr-api-dev-8587dff54d-99s9r    1/1     Running   0          6m29s

# NAME                              TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)   AGE
# service/hello-mediatr-api-dev-svc ClusterIP   10.101.34.169   <none>        80/TCP    19m
...
# NAME                                              DESIRED   CURRENT   READY   AGE
# replicaset.apps/hello-mediatr-api-dev-6cb4fcfbfb  0         0         0       19m
# replicaset.apps/hello-mediatr-api-dev-8587dff54d  2         2         2       7m16s


#================================================================
# Troubleshooting if the service is inaccessible (the real port actually exposed)
#================================================================
kubectl exec -it  pod/hello-mediatr-api-dev-8587dff54d-99s9r -- bash
# root@hello-mediatr-api-dev-8587dff54d-99s9r:/app
# root@hello-mediatr-api-dev-8587dff54d-99s9r:/app apt-get update && apt-get install -y net-tools
# root@hello-mediatr-api-dev-8587dff54d-99s9r:/app netstat -tuln
