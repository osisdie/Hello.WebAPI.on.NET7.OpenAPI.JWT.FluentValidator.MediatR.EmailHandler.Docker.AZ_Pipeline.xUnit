...
namespace Hello.MediatR.Endpoint.Controllers.AuthActions
{
    public partial class AuthController : DomainContollerBase
    {
        ...
        public async Task<IActionResult> RefreshToken_latest([FromBody] AuthRefreshToken_RequestDto requestDto) => await RefreshToken_v202104(requestDto);
        ...
        [HttpPost]
        [SwaggerResponse((int)HttpStatusCode.OK, Type = typeof(ISvcResponseBaseDto<JwtTokenDto>))]
        public async Task<IActionResult> RefreshToken_v202104([FromBody] AuthRefreshToken_RequestDto requestDto) => await RefreshToken_v202103(requestDto);
